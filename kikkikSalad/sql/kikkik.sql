...
select * from (select * from order_tbl t left join order_detail d on t.order_no = d.order_no) where order_date between sysdate-100 and sysdate order by order_date;
delete from order_tbl where order_no between 4 and 13;
